...
def create_app():
    ...
    app.config.from_mapping(
        ...
        #DATABASE = os.path.join('postgres://fzqtnqpvwbibyn:bb4eb6098100999c883fe1ab374a046394f8db35bc93e24ee75d2a8a2b8d2360@ec2-3-228-235-79.compute-1.amazonaws.com:5432/d20m8qevefnne7')
    )
